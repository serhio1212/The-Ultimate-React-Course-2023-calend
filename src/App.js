...
import TrReset from "./TrReset/TrReset.jsx";
        ...
        <div className="App">
            <div className={cs.mainGrid}>
                <div className="cursor">
                    ...
                    <Count count={count} setCount={setCount} countMinus={countMinus} countPlus={countPlus} step={step}/>
                    <Ddate count={count} setCount={setCount} countMinus={countMinus} countPlus={countPlus}/>
                    {count !== 0 || step !== 1 ? <TrReset count={count} setCount={setCount} step={step} setStep={setStep} /> : null}
                </div>
            </div>
            <div className="App2">
